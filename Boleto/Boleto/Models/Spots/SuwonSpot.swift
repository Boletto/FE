...
//        CLLocationCoordinate2D(latitude: 37.2432, longitude: 127.0798)
    ...
    var landmarks: [Badge] {
        return [
            ...
            Badge(badgetype: .sw04, latitude: 37.2661617, longtitude: 126.9998207), // 월화원 갖
            Badge(badgetype: .sw03, latitude:  37.24848, longtitude: 127.07681), // 수원화성가자
//            Badge(badgetype: .sw01, latitude: 37.2652416, longtitude: 127.0377224), // 월화원
            Badge(badgetype: .sw01, latitude: 37.25166, longtitude: 127.07122    ), // 월화원
